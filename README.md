...
ミスせず**3秒以内に連続で捕まえる**とコンボが伸び、1捕獲の得点が **+1 → +2 → +3（上限）** と増えます。
空振りタップは「お手つき」＝**0.5秒タップ不能＋コンボリセット**。画面中央連打では稼げません。狙って当てるのが最強戦略です。

### ゴールデンおーつか

数秒おきに本物が約3秒だけ金色になります。金色中は**常にマックススピードで爆走**しますが、捕まえると**コンボ点+2のボーナス**（最低+3点）。捕獲時には「ウルトラソウル！」のボイスが鳴ります。
...
└── assets/
    ...
    ├── qr.png                  公開URLのQRコード
    ├── ultrasoul.m4a           ゴールデン捕獲ボイス（macOS say Kyoko をピッチアップ）
